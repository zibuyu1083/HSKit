 ...
 *
 *  @param cornerRadius     圆角半径
 *  @param lineWidth     border宽度
 *  @param lineColor     border颜色
 */

-(void)borderlayerCornerRadius:(CGFloat )cornerRadius LineWidth:(CGFloat)lineWidth LineColor:(UIColor *)lineColor;
