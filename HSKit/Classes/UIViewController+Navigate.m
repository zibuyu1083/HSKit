...
- (void)setLeftBarItemWithBackImage {
    [self setLeftBarItemWithImage:@"ic_back_gray" HighlightImage:@"ic_back_gray"];
}
...
- (void)setLeftBarItemWithImage:(NSString *)Image
    ...
    if ([[UIDevice currentDevice].systemVersion integerValue] < 10) {
        ...
        UIButton *backBtn = [[UIButton alloc] initWithFrame:CGRectMake(-20.f, 0.f, backImg.size.width, backImg.size.height)];
        backBtn.contentMode = UIViewContentModeScaleAspectFit;
        [backBtn setImage:backImg forState:UIControlStateNormal];
        ...
        UIBarButtonItem *tempItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFixedSpace target:nil action:nil];
        tempItem.width = -12;
        
        //self.navigationItem.leftBarButtonItems = @[tempItem,barItem];
        ...
        UIBarButtonItem *barItem = [[UIBarButtonItem alloc] initWithImage:normalImage style:UIBarButtonItemStylePlain target:self action:@selector(popController)];
...
- (void)setLeftBarItemWithImage:(NSString *)Image
                 HighlightImage:(NSString *)highImage navigationItem:(UINavigationItem *)navigationItem{
    UIImage *backImg = [UIImage imageNamed:Image];
    UIButton *backBtn = [[UIButton alloc] initWithFrame:CGRectMake(-20.f, 0.f, backImg.size.width, backImg.size.height)];
    backBtn.contentMode = UIViewContentModeScaleAspectFit;
    [backBtn setImage:backImg forState:UIControlStateNormal];
    ...
    navigationItem.leftBarButtonItems = @[tempItem,barItem];
...
- (void)setRightBarItemWithTitle:(NSString *)title selector:(SEL)selector color:(UIColor *)color {
...
//自加
- (void)setLeftBarItemWithTitle:(NSString *)title font:(NSInteger)font selector:(SEL)selector {
    UIButton *rightButton = [UIButton buttonWithType:UIButtonTypeCustom];
...
- (void)setRightBarItemWithImage:(NSString *)Image HighlightImage:(NSString*)highImage selector:(SEL)selector navigationItem:(UINavigationItem *)navigationItem{
    UIButton *backButton = [UIButton buttonWithType:UIButtonTypeCustom];
    backButton.imageEdgeInsets = UIEdgeInsetsMake(0, 5, 0, -5);
    backButton.frame = CGRectMake(0, 0, 40, 40);
    backButton.backgroundColor = [UIColor clearColor];
...
- (void)setRightBarItemWithImage:(NSString *)Image SelectImage:(NSString*)selectImage select:(BOOL) select selector:(SEL)selector{
    UIButton *backButton = [UIButton buttonWithType:UIButtonTypeCustom];
    backButton.imageEdgeInsets = UIEdgeInsetsMake(0, 5, 0, -5);
    backButton.frame = CGRectMake(0, 0, 40, 40);
    backButton.backgroundColor = [UIColor clearColor];
    [backButton setImage:[UIImage imageNamed:Image] forState:UIControlStateNormal];
    [backButton setImage:[UIImage imageNamed:selectImage] forState:UIControlStateSelected];
